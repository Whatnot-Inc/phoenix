defmodule Phoenix.Channel.Server do
  ...
  def dispatch(subscribers, from, %Broadcast{event: event} = msg) do
    ...
    Enum.reduce(subscribers, %{}, fn
      ...
      {pid, {:fastlane, fastlane_pid, serializer, event_intercepts, _assigns}}, cache ->
  ...
  defp init_join(socket, channel, topic) do
    %{transport_pid: transport_pid, serializer: serializer, assigns: assigns, pubsub_server: pubsub_server} = socket
    ...
    fastlane = {:fastlane, transport_pid, serializer, channel.__intercepts__(), assigns}
